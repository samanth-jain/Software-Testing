...
class EcomTest(unittest.TestCase):
    ...
    def test_01(self):
        ...
        driver.save_screenshot('D:\coding\eCommerce-Website-Automation-Selenium-main\Screenshots'+'screenshot#'+str(random.randint(0,101))+'.png')
...
if __name__ == '__main__':
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output="D:\coding\eCommerce-Website-Automation-Selenium-main\Reports"))
