...
class CheckoutPage():
    ...
    def complete_checkout_options(self):
        self.driver.find_element('xpath',self.guest_checkout_radiobutton_xpath).click()
        self.driver.find_element('xpath',self.continue1_xpath).click()

    def enter_billing_details(self, fname, lname, email, tele, add1, city, pcode, country, state):
        self.driver.find_element('xpath',self.firstname_xpath).clear()
        self.driver.find_element('xpath',self.firstname_xpath).send_keys(fname)
        self.driver.find_element('xpath',self.lastname_xpath).clear()
        self.driver.find_element('xpath',self.lastname_xpath).send_keys(lname)
        self.driver.find_element('xpath',self.email_xpath).clear()
        self.driver.find_element('xpath',self.email_xpath).send_keys(email)
        self.driver.find_element('xpath',self.telephone_xpath).clear()
        self.driver.find_element('xpath',self.telephone_xpath).send_keys(tele)
        self.driver.find_element('xpath',self.address1_xpath).clear()
        self.driver.find_element('xpath',self.address1_xpath).send_keys(add1)
        self.driver.find_element('xpath',self.city_xpath).clear()
        self.driver.find_element('xpath',self.city_xpath).send_keys(city)
        self.driver.find_element('xpath',self.postcode_xpath).clear()
        self.driver.find_element('xpath',self.postcode_xpath).send_keys(pcode)

        country_val = self.driver.find_element('xpath',self.country_xpath)
        dropdown1 = Select(country_val)
        dropdown1.select_by_visible_text(country)

        state_val = self.driver.find_element('xpath',self.region_xpath)
    ...
    def complete_billing_details(self, fname, lname, email, tele, add1, city, pcode, country, state):
        ...
        self.driver.find_element('xpath',self.continue2_xpath).click()

    def complete_delivery_method(self):
        self.driver.find_element('xpath',self.continue4_xpath).click()

    def complete_payment_method(self):
        self.driver.find_element('xpath',self.tnc_xpath).click()
        self.driver.find_element('xpath',self.continue5_xpath).click()
    ...
    def confirm_order_method(self):
        ...
        self.driver.find_element('xpath',self.confirmorder_xpath).click()
