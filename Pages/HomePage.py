...
class HomePage():
    def __init__(self, driver):
        ...
        self.show_all_laptop_notebook_xpath = "//a[normalize-space()='Show AllLaptops & Notebooks']"
    ...
    def click_phone_pda_option(self):
        self.driver.find_element('xpath',self.phone_pda_option_xpath).click()

    def hover_laptop_notebook_option(self):
        laptops = self.driver.find_element('xpath',self.laptop_notebook_xpath)
        self.action.move_to_element(laptops).perform()

    def click_show_all_laptop_notebook_option(self):
        self.driver.find_element('xpath',self.show_all_laptop_notebook_xpath).click()

    def click_cart_button(self):
        self.driver.find_element('xpath',self.cart_button_xpath).click()

    def click_checkout_cart_button(self):
        self.driver.find_element('xpath',self.checkout_button_xpath).click()
